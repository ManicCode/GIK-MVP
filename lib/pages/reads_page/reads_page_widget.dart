...
import 'reads_page_model.dart';
export 'reads_page_model.dart';

class ReadsPageWidget extends StatefulWidget {
  const ReadsPageWidget({super.key});

  @override
  State<ReadsPageWidget> createState() => _ReadsPageWidgetState();
}

class _ReadsPageWidgetState extends State<ReadsPageWidget> {
  late ReadsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReadsPageModel());
                              ...
                              Expanded(
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      12.0, 0.0, 4.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.commentBoxTextController,
