                  ...
                  children: [
                                              ...
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  image: DecorationImage(
                                                    fit: BoxFit.cover,
                                                    image: Image.asset(
                                                      'assets/images/cloud+upload+file+storage+upload+icon-1320190558968694328.png',
                                                    ).image,
                                                  ),
                                                ),
                                                child: StreamBuilder<
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: StreamBuilder<List<CategoryRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<CategoryRecord>
                                  categoryDropDownCategoryRecordList =
                                  snapshot.data!;
                              ...
                              return FlutterFlowDropDown<String>(
                                ...
                                options: categoryDropDownCategoryRecordList
                                    .map((e) => e.output)
                                    .toList(),
                        ...
                        Container(
                          ...
                          child: Visibility(
                            visible: _model.categoryDropDownValue != null &&
                            ...
                            child: StreamBuilder<List<ItemRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ItemRecord> itemDropDownItemRecordList =
                                    snapshot.data!;

                                return FlutterFlowDropDown<String>(
                                  controller:
                                      _model.itemDropDownValueController ??=
                                          FormFieldController<String>(null),
                                  options: itemDropDownItemRecordList
                                      .map((e) => e.output)
                                      .toList(),
                                  onChanged: (val) => safeSetState(
                                      () => _model.itemDropDownValue = val),
                                  width: 180.0,
                                  height: 50.0,
                                  textStyle: FlutterFlowTheme.of(context)
                                      .bodyMedium
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        controller: _model.conditionSelectValueController ??=
                            FormFieldController<String>(null),
                        options: const ['Brand New', 'Like New', 'Fairly Used'],
                        onChanged: (val) => safeSetState(
                            () => _model.conditionSelectValue = val),
                        width: double.infinity,
                        height: 60.0,
                        textStyle:
                  ...
                  child: StreamBuilder<List<ListingRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return FFButtonWidget(
                        onPressed: () async {
                          await ListingRecord.collection
                              .doc()
                              .set(createListingRecordData(
                                itemName: _model.itemNameTextController.text,
                                category: _model.categoryDropDownValue,
                                itemList: _model.itemDropDownValue,
                                price: int.tryParse(
                                    _model.itemPriceTextController.text),
                                condition: _model.conditionSelectValue,
                                bio: _model.shortBioTextController.text,
                                image1: _model.uploadedFileUrl2,
                                image2: _model.uploadedFileUrl3,
                                image3: _model.uploadedFileUrl4,
                              ));
