...
import 'accommodation_list_page_model.dart';
export 'accommodation_list_page_model.dart';

class AccommodationListPageWidget extends StatefulWidget {
  const AccommodationListPageWidget({super.key});

  @override
  State<AccommodationListPageWidget> createState() =>
      _AccommodationListPageWidgetState();
}

class _AccommodationListPageWidgetState
    extends State<AccommodationListPageWidget> {
  late AccommodationListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccommodationListPageModel());
