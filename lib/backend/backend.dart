...
import 'schema/condition_record.dart';
import 'schema/listing_record.dart';
import 'schema/chats_record.dart';
import 'schema/essages_record.dart';
...
export 'schema/condition_record.dart';
export 'schema/listing_record.dart';
export 'schema/chats_record.dart';
export 'schema/essages_record.dart';
...
/// Functions to query ConditionRecords (as a Stream and as a Future).
Future<int> queryConditionRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ConditionRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ConditionRecord>> queryConditionRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ConditionRecord.collection,
      ConditionRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ConditionRecord>> queryConditionRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query EssagesRecords (as a Stream and as a Future).
Future<int> queryEssagesRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EssagesRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EssagesRecord>> queryEssagesRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      EssagesRecord.collection(parent),
      EssagesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EssagesRecord>> queryEssagesRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
